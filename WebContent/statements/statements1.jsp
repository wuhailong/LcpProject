...
%>
<center>
    起始时间： <input type="text" name="text1" style="width:100px" id="text1" readonly="true" value="<%=begintime %>" onFocus="CalendarWebControl.show(this,false,this.value);">&nbsp;&nbsp;
    结束时间：<input type="text" name="text2" style="width:100px"  id="text2" readonly="true" value="<%=riqi%>" onFocus="CalendarWebControl.show(this,false,this.value);">&nbsp;
 <% if(!"".equals(deptCode) && Integer.parseInt(deptCode)>0){
	if(deptCode.equals("3070000")){
		%>
 ...
 <!-- -1代表默认查询所有科室 -->
  ...
  <%}%>
 <label>
   <input type="button" name="button" onclick="sub()" id="button" value="查看">
 </label>
 </center>
...
var calendar;
function sub(){
	var deptcodevalue=deptcodevalueks;
	//alert(deptcodevalue+"---"+deptcodevalueyw);
...
/************** 关于AgetimeCalendar *********************/
  this.about=function(){
   ...
   strAbout+="〉\t: 下一月\n";
   strAbout+="〉〉\t: 下一年\n";
   strAbout+="\nWeb日历选择输入控件\tVer:v1.1\t\nDesigned By:嘉和美康kry \t\t2011.12.10\t\n";
   alert(strAbout);
  }
