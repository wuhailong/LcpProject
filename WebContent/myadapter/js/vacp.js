		...
		success : function(data) {
			for ( var i = 0; i < data["cp_va"].length; i++) {
				var tr = "<tr onclick=getVaNode(); id=option" + i
						+ " style='font-size:12px,font-family:Helvetica, Arial, sans-serif'><td style='display: none'>"
								...
								success : function(data) {
									...
									for ( var i = 0; i < data["cp_orders"].length; i++) {
										if (nodeflag != data["cp_orders"][i]["node_name"]) {
											parientid++;
											tr = "<tr data-tt-id='"+ parientid+ "' style='font-size:12px,font-family:Helvetica, Arial, sans-serif' ><td><span class='folder'>"+ data["cp_orders"][i]["node_name"]+ "</span></td><td>--</td><td>--</td></tr>";
											$('#orderseqs').append(tr);
										}										
										if (ordergroupflag != data["cp_orders"][i]["order_group"]) {
											ordergroupid++;
											tr = "<tr data-tt-id='"+ parientid+'-'+ordergroupid+ "' data-tt-parent-id='"+ parientid+ "' style='font-size:12px,font-family:Helvetica, Arial, sans-serif' ><td><span class='folder'>"+ data["cp_orders"][i]["order_group"]+ "</span></td><td>--</td><td>"+ data["cp_orders"][i]["groupcount"]+"</td></tr>";
										...
										tr = "<tr data-tt-id='"+ parientid+'-'+ordergroupid+ '-'+ i+ "' data-tt-parent-id='"+ parientid+'-'+ordergroupid+ "' style='font-size:12px,font-family:Helvetica, Arial, sans-serif'><td><span class='file'>"+ data["cp_orders"][i]["order_text"]+ "</span></td><td>"+ data["cp_orders"][i]["order_no"]+ "</td><td>"+ data["cp_orders"][i]["mycount"]+ "</td></tr>";
										$('#orderseqs').append(tr);
